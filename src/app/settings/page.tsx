        ...
        <p className="mt-0.5 max-w-prose text-xs muted">
          {normsEnabled(config)
            ? `Пороги выше — сетевые. Там, где у лавки есть своя норма, «водитель» и «повар»
               ...
               Часы выхода поваров раздаются по факту прихода: пришедший раньше всех
               отвечает за самый ранний час. Сколько поваров в смене, из справочника не
               берётся — норма это час, а не число людей.`
