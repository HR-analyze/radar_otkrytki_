 ...
 * руками, и единственный, ради которого сюда заходят каждый день. Общий
 * результат никуда не делся — он первый в списке «Критерий» под подписью
 * «Все», и выбранное руками всегда главнее (`criterion=all` остаётся в
 * ссылке, см. Filters).
 */
