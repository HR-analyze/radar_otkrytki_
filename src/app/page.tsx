  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Filters
        ...
        /* Фильтра критерия на сводке нет: её значение по умолчанию —
           «Общий результат», а этот пункт из фильтров убран (см. Filters,
           SHOW_TOTAL_OPTION). Сводка и так считается по всем критериям, а
           разрез по одному — это радар, куда ведут плитки ниже. Вернуть
           фильтр — убрать эту строку. */
        showCriterion={false}
      />
